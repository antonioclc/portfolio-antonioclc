    ...
    <div className="about">
      ...
      <div className="skills-container fadeIn">
        <div className="skills-nav">
          <button className="skills-nav-btn" onClick={() => setSkillPosition(0)}>
            <img src={html} alt="html" className="skills-nav-icon" />
          </button>
          <button className="skills-nav-btn" onClick={() => setSkillPosition(1)}>
            <img src={css} alt="css" className="skills-nav-icon" />
          </button>
          <button className="skills-nav-btn" onClick={() => setSkillPosition(2)}>
            <img src={js} alt="js" className="skills-nav-icon" />
          </button>
          <button className="skills-nav-btn" onClick={() => setSkillPosition(3)}>
            <img src={react} alt="react" className="skills-nav-icon" />
          </button>
          <button className="skills-nav-btn" onClick={() => setSkillPosition(4)}>
